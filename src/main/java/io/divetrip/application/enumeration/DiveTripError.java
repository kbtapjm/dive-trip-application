package io.divetrip.application.enumeration;

import io.divetrip.application.exception.error.DiveTripException;
...
public enum DiveTripError {
    ...
    TRIP_RESERVATION_DUPLICATED("E602", "valid.trip-reservation.already.exists", 400),
    TRIP_RESERVATION_PAYMENT_COULD_NOT_MADE("E603", "valid.trip-reservation.payment.could.not.made", 400),
    TRIP_RESERVATION_PAYMENT_NOT_FOUND("E604", "valid.trip-reservation-payment.not.found", 404),
