...
import io.divetrip.application.mapper.request.TripCreateRequestMapper;
import io.divetrip.application.mapper.request.TripLodgingRequestMapper;
import io.divetrip.application.mapper.request.TripScheduleRequestMapper;
import io.divetrip.application.mapper.request.TripStatusHistoryRequestMapper;
import io.divetrip.application.mapper.response.TripLodgingResponseMapper;
import io.divetrip.application.mapper.response.TripResponseMapper;
import io.divetrip.application.mapper.response.TripScheduleResponseMapper;
import io.divetrip.application.mapper.response.TripStatusHistoryResponseMapper;
